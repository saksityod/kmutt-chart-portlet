...
var checkDataFilterDuplicateFn = function(object,keyCheck){
	var dataReturn=true;
...
//[* Connection Name,* Connection string,* Driver class,* Hibernate Dialect,* User,* Password]
	if(!checkDataFilterDuplicateFn($("#web_${ns} #filterId option").get(),$("#web_${ns} #filterName").val())){
	...
	var listDataFilterTableFn = function(){
