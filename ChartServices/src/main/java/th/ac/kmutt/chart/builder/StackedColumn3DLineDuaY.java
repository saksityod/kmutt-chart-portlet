...
public class StackedColumn3DLineDuaY extends CommonChart implements Chart {
	private static final Logger logger = Logger.getLogger(ServiceConstant.LOG_APPENDER);
	
	List<Object[]> data;
	public StackedColumn3DLineDuaY(){
		super("StackedColumn3DLineDuaY");  
	}
	@Override
		...
		try{
			...
			for( Object[] resultRow : this.data){
				if(!seriesList.contains(resultRow[1])){ 
					...
					attr.put("renderAs", resultRow[3]);
					attr.put("parentYAxis", resultRow[4]);
					seriesJson.put(attr);
				}
