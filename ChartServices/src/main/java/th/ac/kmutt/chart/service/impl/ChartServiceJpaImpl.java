...
public class ChartServiceJpaImpl implements ChartService {
	...
	public Integer saveChartFeatureInstanceEntity(ChartFeatureInstanceEntity transientInstance)
			throws DataAccessException {
		return chartRepository.saveChartFeatureInstanceEntity(transientInstance);
	}

	public Integer updateChartFeatureInstanceEntity(ChartFeatureInstanceEntity transientInstance)
			throws DataAccessException {
		return chartRepository.updateChartFeatureInstanceEntity(transientInstance);
	}

	public Integer deleteChartFeatureInstanceEntity(ChartFeatureInstanceEntity persistentInstance)
			throws DataAccessException {
	...
	public Integer saveChartFeatureMappingEntity(ChartFeatureMappingEntity transientInstance)
			throws DataAccessException {
		return chartRepository.saveChartFeatureMappingEntity(transientInstance);
	}

	public Integer updateChartFeatureMappingEntity(ChartFeatureMappingEntity transientInstance)
			throws DataAccessException {
		return chartRepository.updateChartFeatureMappingEntity(transientInstance);
	}

	public Integer deleteChartFeatureMappingEntity(ChartFeatureMappingEntity persistentInstance)
			throws DataAccessException {
		return chartRepository.deleteChartFeatureMappingEntity(persistentInstance);
	}

	public ChartFeatureMappingEntity findChartFeatureMappingEntityById(ChartFeatureMappingEntityPK id)
			throws DataAccessException {
		return chartRepository.findChartFeatureMappingEntityById(id);
	}

	public Integer saveChartFilterInstanceEntity(ChartFilterInstanceEntity transientInstance)
			throws DataAccessException {
		return chartRepository.saveChartFilterInstanceEntity(transientInstance);
	}

	public Integer updateChartFilterInstanceEntity(ChartFilterInstanceEntity transientInstance)
			throws DataAccessException {
		return chartRepository.updateChartFilterInstanceEntity(transientInstance);
	}

	public Integer deleteChartFilterInstanceEntity(ChartFilterInstanceEntity persistentInstance)
			throws DataAccessException {
	...
	public Integer saveServiceChartMappingEntity(ServiceChartMappingEntity transientInstance)
			throws DataAccessException {
		return chartRepository.saveServiceChartMappingEntity(transientInstance);
	}

	public Integer updateServiceChartMappingEntity(ServiceChartMappingEntity transientInstance)
			throws DataAccessException {
		return chartRepository.updateServiceChartMappingEntity(transientInstance);
	}

	public Integer deleteServiceChartMappingEntity(ServiceChartMappingEntity persistentInstance)
			throws DataAccessException {
		return chartRepository.deleteServiceChartMappingEntity(persistentInstance);
	}

	public ServiceChartMappingEntity findServiceChartMappingEntityById(ServiceChartMappingEntityPK id)
			throws DataAccessException {
	...
	public Integer saveServiceFilterMappingEntity(ServiceFilterMappingEntity transientInstance)
			throws DataAccessException {
		return chartRepository.saveServiceFilterMappingEntity(transientInstance);
	}

	public Integer updateServiceFilterMappingEntity(ServiceFilterMappingEntity transientInstance)
			throws DataAccessException {
		return chartRepository.updateServiceFilterMappingEntity(transientInstance);
	}

	public Integer deleteServiceFilterMappingEntity(ServiceFilterMappingEntity persistentInstance)
			throws DataAccessException {
		return chartRepository.deleteServiceFilterMappingEntity(persistentInstance);
	}

	public ServiceFilterMappingEntity findServiceFilterMappingEntityById(ServiceFilterMappingEntityPK id)
			throws DataAccessException {
	 ...
	 * 
	 * public List InternationalCompareAllStudent(InBoundOutBoundServiceM
	 * persistentInstance){ return
	 * chartRepository.InternationalCompareAllStudent(persistentInstance); }
	 * 
	 * 
	 * public List EmpInternationalCompareAllEmp(InBoundOutBoundServiceM
	 * persistentInstance){ return
	 * chartRepository.EmpInternationalCompareAllEmp(persistentInstance); }
	 * 
	 * public List ProgramInternationalCompareAllProgram(InBoundOutBoundServiceM
	 * persistentInstance){ return
	 * chartRepository.ProgramInternationalCompareAllProgram(persistentInstance); }
	 * 
	 * public List
	 * InternationalCompareAllStudentProgramInter(InBoundOutBoundServiceM
	 * persistentInstance){ return
	 * chartRepository.InternationalCompareAllStudentProgramInter(persistentInstance
	 * ); }
	 * 
	 * public List InternationalCompareAllStudentByFaculty(InBoundOutBoundServiceM
	 * persistentInstance){ return
	 * chartRepository.InternationalCompareAllStudentByFaculty(persistentInstance);
	 * }
	 * 
	 * public List InternationalCompareAllEmpByFaculty(InBoundOutBoundServiceM
	 * persistentInstance){ return
	 * chartRepository.InternationalCompareAllEmpByFaculty(persistentInstance); }
	 */

	public List<FilterM> getGlobalFilter() {
		logger.info("::GetGobalFilter ==> Start get gobal filter");
		...
		for (FilterEntity fe : feList) {
			...
			BeanUtils.copyProperties(fe, fm); // copyProperties(Source, Target)
			logger.info("::GetGobalFilter --> Filter ------------------------");
			logger.info("::GetGobalFilter --> Filter Id = " + fm.getFilterId());
			logger.info("::GetGobalFilter --> Filter Name = " + fm.getFilterName());
			logger.info("::GetGobalFilter --> Value Type = " + fm.getValueType());
			logger.info("::GetGobalFilter --> Select Value = " + fm.getSelectedValue());
			logger.info("::GetGobalFilter --> Connection Id = " + fm.getConnId());
			

			// filterValue
			List<FilterM> paramFilter = chartRepository.findParamFilterMapping(fm.getFilterId());
			// Debug result value
			for (FilterM fil : paramFilter) {
				logger.info("::GetGobalFilter ----> Parent Filter ----------------------");
				logger.info("::GetGobalFilter ----> Filter Id = " + fil.getFilterId());
				logger.info("::GetGobalFilter ----> Filter Name = " + fil.getFilterName());
				logger.info("::GetGobalFilter ----> Value Type = " + fil.getValueType());
				logger.info("::GetGobalFilter ----> Select Value = " + fil.getSelectedValue());
				logger.info("::GetGobalFilter ----> Connection Id = " + fil.getConnId());
			}
			
			
			// DatasourceConnectionEntity dc = null;
			List<FilterValueM> fvs = datasourceRepository.fetchFilterValueCascade(fe, paramFilter);
			/*for(FilterValueM fv : fvs) {
				logger.info("::GetGobalFilter ------> Values Filter ----------------------");
				logger.info("::GetGobalFilter ------> keyMapping ="+fv.getKeyMapping());
				logger.info("::GetGobalFilter ------> valueMapping ="+fv.getKeyMapping());
				logger.info("::GetGobalFilter ------> values ="+fv.getValues());
				logger.info("::GetGobalFilter ------> valueList ="+fv.getValueList());
				logger.info("::GetGobalFilter ------> type ="+fv.getType());
				logger.info("::GetGobalFilter ------> refFilterId ="+fv.getRefFilterId());
			}*/
		...
		logger.info("::GetGobalFilter ==> Return get gobal filter");
		return filters;
	}
		...
		if (chartInsEnt != null) {
			...
			try {
				...
				for (FilterM f : allFilters) {
					System.out.println("filter " + f.getFilterId() + " " + f.getFilterName() + " , "
							+ f.getSelectedValue() + " , g:" + f.getGlobalFlag());
	...
	public List<FilterM> getFilterOfService(Integer serviceId, String userId) {
		...
		for (Object[] result : results) {
			...
			for (FilterM lookup : paramFilter) {
				...
				// System.out.println("#:lookup.getFilterName(): " +lookup.getFilterName()+" " +
				// lookup.getSelectedValue() + " d:"+lookup.getDefaultValue() );
			}
			FilterEntity fe = new FilterEntity();
	...
	public FilterInstanceM getFilterInstance(FilterInstanceM fim) {
		...
		for (Object[] result : resultSet) {
			...
			// override
			if (fim.getFilterList() != null)
				initParamFilter.addAll(fim.getFilterList()); // add global ?
