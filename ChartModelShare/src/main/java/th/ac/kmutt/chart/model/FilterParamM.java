...
public class FilterParamM extends ImakeXML implements Serializable {
	...
	public List<FilterParamM> getFilterList() {
		return filterList;
	}
	public void setFilterList(List<FilterParamM> filterList) {
	...
	public String getParamFilterName() {
		return paramFilterName;
	}
	public void setParamFilterName(String paramFilterName) {
		this.paramFilterName = paramFilterName;
	}
	...
	public String getParamSelectedValue() {
		return paramSelectedValue;
	}
	public void setParamSelectedValue(String paramSelectedValue) {
		this.paramSelectedValue = paramSelectedValue;
	}
}
